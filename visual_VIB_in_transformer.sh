...
do
    ...
    python main_visual_VIB_in_tran.py --train True --model SL_module --batch_size 100 --modal visual --device 1 --type ${type} --beta ${value} --epochs ${i} --tag VIB_in_transformer_epoch${i}_${time_tag} --path ${path}
done
