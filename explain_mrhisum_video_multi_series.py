...
if __name__ == "__main__":
    ...
    for beta in [ 1, 2, 3, 4, 5, 6]:
        ...
        try:
            model.load_state_dict(torch.load(f'/home/jay/usb/summaries0423/multi0423/cib/mr/{number_list[beta]}/mr_hisum_cib_ep200_03261018/best_mAP50_model/Proportion_100%_best_map50_epoch100.pkl', map_location='cpu'))
            print(f"Loading model from: /home/jay/usb/summaries0423/multi0423/cib/mr/{number_list[beta]}/mr_hisum_cib_ep200_03261018/best_mAP50_model/Proportion_100%_best_map50_epoch100.pkl")
            ...
            model.load_state_dict(torch.load(f'/home/jay/usb/summaries0423/multi0423/cib/mr/{number_list[beta]}/mr_hisum_cib_ep200_03261018/best_mAP50_model/Proportion_100%_best_map50_epoch50.pkl', map_location='cpu'))
            print(f"Loading model from: /home/jay/usb/summaries0423/multi0423/cib/mr/{number_list[beta]}/mr_hisum_cib_ep200_03261018/best_mAP50_model/Proportion_100%_best_map50_epoch50.pkl")
        model.to(DEVICE)
        model.eval()
