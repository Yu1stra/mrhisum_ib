...
class Solver(object):
    ...
    def build(self):
        ...
        self.model = SL_module_VIB_in_transformer_after_ff(input_dim=128, depth=5, heads=8, mlp_dim=3072, dropout_ratio=0.5)
        ...
        for data in dataloader:
            ...
            with torch.no_grad():
                ...
                if kl_loss < 1e-8 and beta > 0:
                    print(f"WARNING in evaluation: KL loss is nearly zero: {kl_loss}")
            #self.optimizer.step()
            # Calculate precision
