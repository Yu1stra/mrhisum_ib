...
do
    ...
    python main_visual_VIB_in_tran_post.py --train True --model SL_module --batch_size 100 --modal visual --device 2 --type ${type} --beta ${value} --epochs ${i} --tag VIBintranPOST_in_transformer_epoch${i}_${time_tag} --path ${path}
done
