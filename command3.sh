...
do
    ...
    do
        ...
        python main.py --train True --model SL_module --batch_size 50 --modal ${modal} --device 1 --lr 0.05 --type ${type} --beta ${value} --epochs ${i} --tag ${cate}_${type}_ep${i}_${time_tag} --path ${path}
    done
done
