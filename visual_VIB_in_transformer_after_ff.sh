...
do
    ...
    python main_visual_VIB_in_tran_after_ff.py --train True --model SL_module --batch_size 100 --modal visual --device 0 --type ${type} --beta ${value} --epochs ${i} --tag VIBintranAfterFF_in_transformer_epoch${i}_${time_tag} --path ${path}
done
