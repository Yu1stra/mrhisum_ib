...
class Solver(object):
    ...
    def build(self):
        ...
        if self.config.type=='base':
            ...
            self.model = SL_module_VIB(input_dim=128, depth=5, heads=8, mlp_dim=3072, dropout_ratio=0.5)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--tag', type = str, default = 'audio_VIB', help = 'A tag for experiments')
    ...
    parser.add_argument('--modal', type=str, default='audio', help='visual,audio,multi')
