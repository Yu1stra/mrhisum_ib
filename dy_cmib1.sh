...
#     done
# done
#python main_dy_cmib_backup.py --train True  --batch_size ${batch_size} --device 0 --modal ${modal} --lr 0.05 --type ${type} --vbeta 0.0009 --abeta 0.0009 --mbeta 0.0009 --epochs ${i} --tag ${cate}_${type}_ep${i}_${time_tag}_samebeta_0.0009 --path ${path} 
#python main_dy_cmib_backup.py --train True  --batch_size ${batch_size} --device 0 --modal ${modal} --lr 0.05 --type ${type} --vbeta 0.0005 --abeta 0.0005 --mbeta 0.0005 --epochs ${i} --tag ${cate}_${type}_ep${i}_${time_tag}_samebeta_0.0005 --path ${path}
python main_dy_cmib_backup.py --train True  --batch_size ${batch_size} --device 1 --modal ${modal} --lr 0.05 --type ${type} --vbeta 0.0001 --abeta 0.0001 --mbeta 0.0001 --epochs ${i} --tag ${cate}_${type}_ep${i}_${time_tag}_samebeta_0.0001 --path ${path}
python main_dy_cmib_backup.py --train True  --batch_size ${batch_size} --device 1 --modal ${modal} --lr 0.05 --type ${type} --vbeta 0.00006 --abeta 0.00006 --mbeta 0.00006 --epochs ${i} --tag ${cate}_${type}_ep${i}_${time_tag}_samebeta_0.00006 --path ${path}
python main_dy_cmib_backup.py --train True  --batch_size ${batch_size} --device 1 --modal ${modal} --lr 0.05 --type ${type} --vbeta 0.00002 --abeta 0.00002 --mbeta 0.00002 --epochs ${i} --tag ${cate}_${type}_ep${i}_${time_tag}_samebeta_0.00002 --path ${path}
