...
#     done
# done
#python main_dy_cmib_backup.py --train True  --batch_size ${batch_size} --device 2 --modal ${modal} --lr 0.05 --type ${type} --vbeta 0.001 --abeta 0.001 --mbeta 0.001 --epochs ${i} --tag ${cate}_${type}_ep${i}_${time_tag}_samebeta_0.001 --path ${path} 
#python main_dy_cmib_backup.py --train True  --batch_size ${batch_size} --device 2 --modal ${modal} --lr 0.05 --type ${type} --vbeta 0.0006 --abeta 0.0006 --mbeta 0.0006 --epochs ${i} --tag ${cate}_${type}_ep${i}_${time_tag}_samebeta_0.0006 --path ${path} 
python main_dy_cmib_backup.py --train True  --batch_size ${batch_size} --device 2 --modal ${modal} --lr 0.05 --type ${type} --vbeta 0.0002 --abeta 0.0002 --mbeta 0.0002 --epochs ${i} --tag ${cate}_${type}_ep${i}_${time_tag}_samebeta_0.0002 --path ${path}
python main_dy_cmib_backup.py --train True  --batch_size ${batch_size} --device 2 --modal ${modal} --lr 0.05 --type ${type} --vbeta 0.00007 --abeta 0.00007 --mbeta 0.00007 --epochs ${i} --tag ${cate}_${type}_ep${i}_${time_tag}_samebeta_0.00007 --path ${path}
python main_dy_cmib_backup.py --train True  --batch_size ${batch_size} --device 2 --modal ${modal} --lr 0.05 --type ${type} --vbeta 0.00003 --abeta 0.00003 --mbeta 0.00003 --epochs ${i} --tag ${cate}_${type}_ep${i}_${time_tag}_samebeta_0.00003 --path ${path}
