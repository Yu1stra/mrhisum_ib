...
do
    ...
    python main_audio_VIB_in_tran.py --train True --model SL_module --batch_size 100 --modal audio --device 1 --type ${type} --beta ${value} --epochs ${i} --tag VIBintranPRE_epoch${i}_${time_tag} --path ${path}
done
